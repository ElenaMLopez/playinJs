1. Hay un error en la instalación de webpack, he reinstalado webpack y símplemente he añadido un script en el archivo package.json para arrancar el build con el comando 
```text
$ npm run watch
```
